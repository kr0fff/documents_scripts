...
function PostExtract(fields, tables, ctx)
    ...
    if fields._InvoiceDate then
        ...
        local months = { { ind = 'januari', eng = 'jan' }, { ind = 'februari', eng = 'feb' }, { ind = 'maret', eng = 'mar' },
                         { ind = 'april', eng = 'apr' }, { ind = 'mei', eng = 'may' }, { ind = 'juni', eng = 'jun' },
                         { ind = 'juli', eng = 'jul' }, { ind = 'agustus', eng = 'aug' }, { ind = 'september', eng = 'sep' },
                         { ind = 'oktober', eng = 'oct' }, { ind = 'november', eng = 'nov' }, { ind = 'desember', eng = 'dec' } }
